...
// Short returns a compact version string suitable for --version output.
...
// UserAgent returns a component-scoped user agent string.
func (i Info) UserAgent(component string) string {
	component = strings.TrimSpace(component)
	if component == "" {
		component = "sisyphus"
	}
	return component + "/" + i.Short()
}
