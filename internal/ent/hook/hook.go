...
// The NotifyChatFunc type is an adapter to allow the use of ordinary
// function as NotifyChat mutator.
type NotifyChatFunc func(context.Context, *ent.NotifyChatMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f NotifyChatFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.NotifyChatMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.NotifyChatMutation", m)
}
...
// Mutate calls f(ctx, m).
func (f SupportRequestFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SupportRequestMutation); ok {
		return f(ctx, mv)
	}
...
// Mutate calls f(ctx, m).
func (f TelegramMessageFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TelegramMessageMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TelegramMessageMutation", m)
}

// The TelegramPeerFunc type is an adapter to allow the use of ordinary
// function as TelegramPeer mutator.
type TelegramPeerFunc func(context.Context, *ent.TelegramPeerMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TelegramPeerFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TelegramPeerMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TelegramPeerMutation", m)
}
