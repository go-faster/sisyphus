...
func (_q *NotifySubscriptionQuery) QueryUser() *NotifyUserQuery {
...
func (_q *NotifySubscriptionQuery) WithUser(opts ...func(*NotifyUserQuery)) *NotifySubscriptionQuery {
	query := (&NotifyUserClient{config: _q.config}).Query()
...
func (_q *NotifySubscriptionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*NotifySubscription, error) {
	...
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *NotifySubscription, e *NotifyUser) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *NotifySubscriptionQuery) loadUser(ctx context.Context, query *NotifyUserQuery, nodes []*NotifySubscription, init func(*NotifySubscription), assign func(*NotifySubscription, *NotifyUser)) error {
