...
func TestHandleSubscribeCmd_DefaultsEventTypes(t *testing.T) {
	...
	require.Equal(t, [2]string{"gitlab", "mr_assigned,mr_review_requested,mr_commented,mr_mentioned,mr_merged,mr_approved,mr_thread_resolved,mr_conflict"}, n.subscribed[42])
